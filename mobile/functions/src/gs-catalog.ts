...
type CatalogEntry = { name: string; manualUrl: string };

const BOLD_MANUAL_URL = "https://newageproducts.com/support-hub/bold-series/";
const BOLD_INSTALL_PDF =
  "https://pdf.lowes.com/productdocuments/c897b0d5-76aa-4d55-9c4a-c718ce1ef8db/12492516.pdf";

/** Gym equipment (Rep, Rogue, generic) */
const GYM_CATALOG: Record<string, CatalogEntry> = {
...
const BOLD_CATALOG: Record<string, CatalogEntry> = {
...
/** Shelving */
const SHELVING_CATALOG: Record<string, CatalogEntry> = {
...
/** Overhead storage */
const OVERHEAD_CATALOG: Record<string, CatalogEntry> = {
...
/** Flooring */
const FLOORING_CATALOG: Record<string, CatalogEntry> = {
...
export function lookupEquipment(id: string): CatalogEntry | null {
  return (
    GYM_CATALOG[id] ??
    BOLD_CATALOG[id] ??
    SHELVING_CATALOG[id] ??
 ...
 */
export function buildVideoConfirmations(
  productSelections: Record<string, any>,
): Array<{ equipmentId: string; equipmentName: string; manualUrl: string; confirmedAt: null }> {
