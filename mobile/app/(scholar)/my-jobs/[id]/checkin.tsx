...
const styles = StyleSheet.create({
  ...
  jobTime: { fontSize: 13, color: "#5a6a80" },
  ...
  stepNumText: { color: "#f1f5f9", fontWeight: "700", fontSize: 13 },
  stepTitle: { fontSize: 16, fontWeight: "700", color: "#f1f5f9" },
  gpsBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  gateBackText: { fontSize: 15, fontWeight: "600", color: "#5a6a80" },
});
