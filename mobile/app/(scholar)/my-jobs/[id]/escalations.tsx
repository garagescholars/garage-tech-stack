...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 10, fontWeight: "800", color: "#f8fafc", letterSpacing: 0.5 },
  timestamp: { fontSize: 12, color: "#64748b" },
  reporter: { fontSize: 14, fontWeight: "700", color: "#f8fafc", marginBottom: 2 },
  ...
  responseSection: { marginTop: 12, borderTopWidth: 1, borderTopColor: "#334155", paddingTop: 10 },
  responseTitle: {
    fontSize: 11,
    fontWeight: "700",
    color: "#64748b",
